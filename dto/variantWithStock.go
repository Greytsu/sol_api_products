...
type VariantStock struct {
	...
	PurchasePrice float64      `json:"purchase_price,omitempty" toml:"purchase_price" yaml:"purchase_price,omitempty"`
	SellingPrice  float64      `json:"selling_price,omitempty" toml:"selling_price" yaml:"selling_price,omitempty"`
