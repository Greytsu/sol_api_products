...
type VariantStock struct {
	...
	PurchasePrice types.NullDecimal `json:"purchase_price,omitempty" toml:"purchase_price" yaml:"purchase_price,omitempty"`
	SellingPrice  types.NullDecimal `json:"selling_price,omitempty" toml:"selling_price" yaml:"selling_price,omitempty"`
